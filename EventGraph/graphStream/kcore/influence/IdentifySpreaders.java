...
package EventGraph.graphStream.kcore.influence;
...
import EventGraph.graphStream.kcore.KCore;
...
public class IdentifySpreaders {
     ...
     * @throws IOException
     */
    public static void writeResults(final String output, final String delim, final int[] spreaders) throws IOException {
