...
public class StringUtil {
    ...
    public static String toString(AtomicDoubleArray data) {

       
        StringBuilder sb = new StringBuilder();
        sb.append("[");
        for (int i = 0; i < data.length(); i++) {
            sb.append(toString(data.get(i)));
            if (i < data.length() - 1)
                sb.append(", ");
        }
        sb.append("]");
	...
	public static char[] arrayToString(double[][] array) {
		// TODO Auto-generated method stub
		return null;
	}

	public static String arrayToString(String[] tokens, int ind) {
		// TODO Auto-generated method stub
