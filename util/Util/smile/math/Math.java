...
import util.Util.smile.sort.QuickSelect;
import util.Util.smile.sort.QuickSort;
import util.Util.smile.sort.SortUtils;
...
public class Math {
     ...
     */
    private static ThreadLocal<util.Util.smile.math.Random> random = new ThreadLocal<util.Util.smile.math.Random>() {
        protected synchronized util.Util.smile.math.Random initialValue() {
            if (firstRNG) {
                ...
                firstRNG = false;
                return new util.Util.smile.math.Random();
            } else {
                ...
                return new util.Util.smile.math.Random(seed);
            }
        }
    };
