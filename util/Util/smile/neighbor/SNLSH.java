...
//import util.Util.smile.hash.MurmurHash;
import util.bloom.Apache.Hash.MurmurHash;
import util.Util.smile.math.distance.HammingDistance;
...
public class SNLSH<E> implements NearestNeighborSearch<SNLSH.AbstractSentence, E>, KNNSearch<SNLSH.AbstractSentence, E>, RNNSearch<SNLSH.AbstractSentence, E>, Serializable {
    ...
    protected static long simhash64(List<String> tokens) {
        ...
        //long hash
        LongHashFunction oneHash =LongHashFunction.xx(seed);
        
        int[] bits = new int[BITS];
        for (String s : tokens) {
            ByteBuffer buffer = ByteBuffer.wrap(s.getBytes());
           // long hc = //MurmurHash.hash2_64(buffer, 0, buffer.array().length, seed);
            long hc =	oneHash.hashBytes(buffer, 0, buffer.array().length);
