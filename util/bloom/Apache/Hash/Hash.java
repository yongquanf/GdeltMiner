...
public abstract class Hash implements Serializable{
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -8116635005551257433L;
...
/** Constant to denote invalid hash type. */
   ...
   * @return one of the predefined constants
   */
  public static int getHashType(Config conf) {
    String name = Config.getConfigProps().getProperty("util.hash.type", "murmur");
   ...
   */
  /*public static Hash getInstance(Config conf) {
